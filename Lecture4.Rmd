...
Capital and Ideology, chap 8-9\
[Wealth Inequality, Class and Caste in India,
1961-2012](https://wid.world/document/n-k-bharti-wealth-inequality-class-and-caste-in-india-1961-2012/)
...
knitr::include_graphics("Plots/plot_4-1.png")
```

```{r echo=FALSE, , fig.align='center', out.width="85%"}
knitr::include_graphics("Plots/plot_4-2.png")
```
...
```{r echo=FALSE, , fig.align='center', out.width="85%"}
knitr::include_graphics("Plots/plot_4-3.png")
```

```{r echo=FALSE, , fig.align='center', out.width="85%"}
knitr::include_graphics("Plots/plot_4-4.png")
```

```{r echo=FALSE, , fig.align='center', out.width="85%"}
knitr::include_graphics("Plots/plot_4-5.png")
```
...
knitr::include_graphics("Plots/plot_4-6.png")
```

```{r echo=FALSE, , fig.align='center', out.width="80%"}
knitr::include_graphics("Plots/plot_4-7.png")
```
...
knitr::include_graphics("Plots/plot_4-8.png")
```

```{r echo=FALSE, , fig.align='center', out.width="100%"}
knitr::include_graphics("Plots/plot_4-9.png")
```
...
```{r echo=FALSE, , fig.align='center', out.width="85%"}
knitr::include_graphics("Plots/plot_4-10.png")
```
...
```{r echo=FALSE, , fig.align='center', out.width="85%"}
knitr::include_graphics("Plots/plot_4-11.png")
```
...
```{r echo=FALSE, , fig.align='center', out.width="100%"}
knitr::include_graphics("Plots/plot_4-12.png")
```
