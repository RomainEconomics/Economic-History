...
Capital and ideology, chap 4-5\
[“The Swedish Sonderweg in Question: Democratization and
Inequality in Comparative Perspective, c. 1750–1920](http://piketty.pse.ens.fr/files/Bengtsson2019.pdf)
...
knitr::include_graphics("Plots/plot_2-1.png")
```


```{r echo=FALSE, , fig.align='center', out.width="90%"}
knitr::include_graphics("Plots/plot_2-2.png")
```


```{r echo=FALSE, , fig.align='center', out.width="90%"}
knitr::include_graphics("Plots/plot_2-3.png")
```
...
```{r echo=FALSE, , fig.align='center', out.width="90%"}
knitr::include_graphics("Plots/plot_2-4.png")
```
...
```{r echo=FALSE, , fig.align='center', out.width="90%"}
knitr::include_graphics("Plots/plot_2-5.png")
```

```{r echo=FALSE, , fig.align='center', out.width="90%"}
knitr::include_graphics("Plots/plot_2-6.png")
```
...
```{r echo=FALSE, , fig.align='center', out.width="90%"}
knitr::include_graphics("Plots/plot_2-7.png")
```
...
```{r echo=FALSE, , fig.align='center', out.width="90%"}
knitr::include_graphics("Plots/plot_2-8.png")
```


```{r echo=FALSE, , fig.align='center', out.width="90%"}
knitr::include_graphics("Plots/plot_2-9.png")
```


```{r echo=FALSE, , fig.align='center', out.width="90%"}
knitr::include_graphics("Plots/plot_2-10.png")
```


```{r echo=FALSE, , fig.align='center', out.width="90%"}
knitr::include_graphics("Plots/plot_2-11.png")
```


```{r echo=FALSE, , fig.align='center', out.width="90%"}
knitr::include_graphics("Plots/plot_2-12.png")
```


```{r echo=FALSE, , fig.align='center', out.width="90%"}
knitr::include_graphics("Plots/plot_2-13.png")
```
